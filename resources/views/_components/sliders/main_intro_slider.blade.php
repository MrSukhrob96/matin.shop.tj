            ...
            <div class="col-lg-4">
                <div class="intro-banners">
                    <div class="banner mb-lg-1 mb-xl-2">
                        <a href="#">
                            <img src="{{ asset('storage/uploads/banners/banner-1.jpg') }}" alt="Banner">
                        </a>
                    ...
                    <div class="banner mb-lg-1 mb-xl-2">
                        <a href="#">
                            <img src="{{ asset('storage/uploads/banners/banner-2.jpg') }}" alt="Banner">
                        </a>
                    ...
                    <div class="banner mb-0">
                        <a href="#">
                            <img src="{{ asset('storage/uploads/banners/banner-3.jpg') }}" alt="Banner">
                        </a>
